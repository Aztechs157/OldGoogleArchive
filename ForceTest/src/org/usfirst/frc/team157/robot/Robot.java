...
import org.usfirst.frc.team157.robot.subsystems.Motor;
...
public class Robot extends IterativeRobot
{
	...
	public static Motor motorSubsystem;
	public static OI oi;
	...
	public void robotInit()
	{
		RobotMap.init();
		oi = new OI();
		motorSubsystem = new Motor();
		// instantiate the command used for the autonomous period
		autonomousCommand = new SetVoltage();
	}
	...
	public static void setupJagForVoltageControl(CANJaguar jag)
	{
		if (jag != null)
		{
			...
			// jag.setPID(2, 0, 0);
			jag.enableControl();
			System.out.println("Encoder Count = " + jag.getPosition());
