...
public class MotorControlAssembly {
    ...
    {
        motor_ = motor;
        pot_ = pot;//new Potentiometer(potChannel, POT_MIN_VALUE, POT_MAX_VALUE, POT_MIN_ANGLE, POT_MAX_ANGLE);
        limitLow_ = null;
        limitHigh_ = null;
        motorDirection_ = 1;
        speed_ = 1;
                                ...
                                DigitalInput limitHigh)
    {
        motor_ = motor;
        pot_ = pot;//new Potentiometer(potChannel, POT_MIN_VALUE, POT_MAX_VALUE, POT_MIN_ANGLE, POT_MAX_ANGLE);
        limitLow_ = limitLow;//new DigitalInput(limitLowChannel);
        limitHigh_ = limitHigh;//new DigitalInput(limitHighChannel);
        motorDirection_ = 1;
        speed_ = 1;
    }
