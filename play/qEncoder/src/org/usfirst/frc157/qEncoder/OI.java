...
public class OI {
    ...
    // Gamepad
    m_setFirst_GamepadLeft.whenPressed(new DoIt(-5));
    m_setFirst_GamepadRight.whenPressed(new DoIt(5));
    ...
    // X,Y,A,B Buttons
//    m_setFirst_X.whenReleased(new DoIt(6));
//    m_setFirst_Y.whenReleased(new DoIt(-6));
//    m_setFirst_A.whenReleased(new DoIt(0));
