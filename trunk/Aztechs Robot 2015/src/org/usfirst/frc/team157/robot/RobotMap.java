...
public class RobotMap
{
	...
	public static DigitalSwitch forkHomeA;
	public static DigitalSwitch forkHomeB;
	public static DigitalSwitch elevatorHomeA;
	public static DigitalSwitch elevatorHomeB;
	...
	public static void init()
	{
		...
		forkHomeA = new DigitalSwitch(1, true);
		forkHomeB = new DigitalSwitch(2, true);
		elevatorHomeA = new DigitalSwitch(3, true);
		elevatorHomeA = new DigitalSwitch(4, true);
	}
}
