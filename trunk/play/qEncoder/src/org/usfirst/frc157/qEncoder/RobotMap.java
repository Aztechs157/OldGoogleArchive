...
public class RobotMap {
    ...
    public static boolean VOLTAGE_CONTROL = false;
    public static int TEST_JAG_CAN_ID_RR = 5;
    public static int TEST_JAG_CAN_ID_RF = 6;
    public static int TEST_JAG_CAN_ID_LR = 4;
    public static int TEST_JAG_CAN_ID_LF = 7;
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    public static CANJaguar encJagRRMotorDrive;    
    public static CANJaguar encJagRFMotorDrive;
    public static CANJaguar encJagLRMotorDrive;    
    public static CANJaguar encJagLFMotorDrive;
    ...
    public static void init() {
        ...
        try {
            ...
            encJagLRMotorDrive = new CANJaguar(TEST_JAG_CAN_ID_LR);
            encJagLFMotorDrive = new CANJaguar(TEST_JAG_CAN_ID_LF);
        ...
        if (SPEED_CONTROL) {
            ...
            setupJagForSpeedControl(encJagLRMotorDrive);
            setupJagForSpeedControl(encJagLFMotorDrive);
        } else if (VOLTAGE_CONTROL) {
            System.out.println("---------------- VOLTAGE Setup --------------------------");
            setupJagForVoltageControl(encJagRRMotorDrive);
            setupJagForVoltageControl(encJagRFMotorDrive);
            setupJagForVoltageControl(encJagLRMotorDrive);
            setupJagForVoltageControl(encJagLFMotorDrive);
            ...
            setupJagForPositionControl(encJagLRMotorDrive);
            setupJagForPositionControl(encJagLFMotorDrive);
        }
     if(encJagRRMotorDrive == null)
        ...
        if(encJagLRMotorDrive == null)
        {
            System.out.println("Why is encJagLRMotorDrive NULL?");
        }
        if(encJagLFMotorDrive == null)
        {
            System.out.println("Why is encJagLFMotorDrive NULL?");
        }
    }
...
//                encJagRRMotorDrive.configNeutralMode(CANJaguar.NeutralMode.kBrake);
    ...
    private static void setupJagForVoltageControl(CANJaguar jag) {
        try {
