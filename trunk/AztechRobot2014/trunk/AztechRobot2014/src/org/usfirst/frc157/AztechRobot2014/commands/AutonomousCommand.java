...
//        int autoMode = switchMaxPosition - (autoSelectSwitch.getValue() + switchStepSize / 2) / switchStepSize;
        ...
        switch (autoMode) {
            case 0:
                // take a single shot
                addSequential(new DriveSpeedForTime(0.5, 0.5, 2)); // move forward at half speed for 1/2 s
...
//                addSequential(new SensorAlignToWall());
                ...
                addSequential(new SleepCommand(0.5));  // sleep for 1/2 seconds 
            ...
            case 1:
                ...
                addSequential(new DriveToRange(RobotMap.Optimum_Shot_Range));  // move to 3m from the wall
//                addSequential(new SensorAlignToWall());
