...
public class  MotorGo extends Command {
    ...
    protected void initialize() {
        System.out.println("About to turn on motor... value = " + Robot.oi.getPot().getValue() + ".");
    }
...
//    Robot.simpleMotor.setSpeed(Robot.oi.getFirstController().getLeftX());
        double value = ((double)(Robot.oi.getPot().getValue())/1024.0)-.5;
        System.out.println("About to turn on motor... value = " + value + ".");
        Robot.simpleMotor.setSpeed(value);
    }
